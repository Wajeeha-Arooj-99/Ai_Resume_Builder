    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            <div className="flex items-center gap-2 text-sm text-violet-800 bg-violet-400/10 rounded-full px-4 py-1">
                <Zap size={16} />
                <span>Trusted by 99% of recruiters</span>
            </div>
            <Title title='Build Resumes That Get You Hired' description='AI-powered resume builder that helps you create ATS-friendly, job-ready resumes in minutes — not hours.' />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-slate-600 max-w-xs">Get real-time AI suggestions to improve wording, skills, and impact — instantly.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Recruiter-Grade Security</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Your data is protected with end-to-end encryption and privacy-first standards.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Custom Resume Versions</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Create multiple tailored resumes for different roles in just a few clicks.</p>
                            </div>
                        </div>
                    </div>
                </div>
