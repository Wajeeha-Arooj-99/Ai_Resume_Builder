          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                {resumeData.public && (
                  <button onClick={handleShare} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-violet-100 to-violet-200 text-violet-600 rounded-lg ring-violet-300 hover:ring transition-colors'>
                ...
                <button onClick={downloadResume} className='flex items-center gap-2 px-6 py-2 text-xs bg-gradient-to-br from-violet-100 to-violet-200 text-violet-600 rounded-lg ring-violet-300 hover:ring transition-colors'>
